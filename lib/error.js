...
function kickOwnerError () {
  return createError(400, 3, 3, 'Owner cannot kick himself from organization');
}
...
function roomNotFound () {
  return createError(404, 4, 1, 'Unable to find room');
}
...
module.exports.kickOwnerError = kickOwnerError;
...
module.exports.roomNotFound = roomNotFound;
