...
function unauthorizedUpdate () {
  return createError(401, 3, 1, 'You only organization owner can perform this action');
}
...
module.exports.unauthorizedUpdate = unauthorizedUpdate;
